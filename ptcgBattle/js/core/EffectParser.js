...
const RULES = [
  ...
  { re: /(?:身上附着能量的)?自己所有的宝可梦[，,]?不会受到对手宝可梦(?:使用|所使用的)招式的效果影响/, act:'prevent_effect', p:()=>({target:'own_field',source:'attack'}) },
  ...
  { re: /如果因为这个招式的伤害[，,]对手(?:的)?宝可梦【昏厥】的话[，,]则多拿取(\d+)张奖赏卡/, act:'extra_prize', p:m=>({count:+m[1],condition:'knocked_out_by_damage'}) },
